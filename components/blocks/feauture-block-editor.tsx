...
export function FeatureBlockEditor({
  ...
  features = [
    {
      title: "Πλούσια Επεξεργασία",
      description: "Δουλέψτε εύκολα με προηγμένα εργαλεία μορφοποίησης.",
      icon: "/documents.svg",
    },
    {
        title: "AI Υποστήριξη",
        description: "Αξιοποιήστε έξυπνες προτάσεις και αυτοματισμούς",
        icon: "/ai.svg",
      },
      {
        title: "Γρήγορη Διαχείριση",
        description: "Βρείτε, εξάγετε και οργανώστε τα έγγραφά σας άμεσα!",
        icon: "/find.svg",
      },
  ...
  screenshotSrc = "/screenshot-editor.png",
}: FeatureBlockProps) {
  return (
      ...
      <div className="container max-w-7xl mx-auto px-4">
        <div className="grid items-end md:grid-cols-12 gap-24 md:gap-24 mb-8 md:mb-12">
          <article className="md:col-span-5 space-y-3 md:space-y-4">
            <h3 className="text-2xl md:text-6xl font-bold text-primary tracking-tight">
              {heading}
            </h3>
