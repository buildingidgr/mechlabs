        ...
        features={[
          {
            ...
            description: "Από τεχνικές εκθέσεις και μελέτες μέχρι προσφορές και συμβόλαια. Επαγγελματικά templates που έχουν δοκιμαστεί στην πράξη.",
            icon: "/template.svg",
          },
          {
            title: "Προσάρμοσε τα όλα",
            description: "Κάθε template είναι πλήρως παραμετροποιήσιμο. Άλλαξε χρώματα, γραμματοσειρές και διάταξη. Πρόσθεσε το λογότυπό σου και φτιάξε το δικό σου στυλ.",
            icon: "/fast.svg",
          },
          {
            title: "Φτιάξε τη συλλογή σου",
            description: "Αποθήκευσε τα αγαπημένα σου templates και μοιράσου τα με την ομάδα σου. Δημιούργησε τη δική σου βιβλιοθήκη με έγγραφα που χρησιμοποιείς συχνά.",
            icon: "/time.svg",
          },
        ]}
